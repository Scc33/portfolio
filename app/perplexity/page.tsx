      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            A modern chat interface built with Next.js and Google Gemini AI,
            inspired by Perplexity&apos;s design with intelligent web search
            integration.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-gray-800/50 backdrop-blur-xs rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-gray-300">
              Powered by Google Gemini 2.0 Flash with intelligent web search
              integration
            </p>
          </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-xs rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-gray-300">
              Automatic web search integration using SerpAPI for current
              information
            </p>
          </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-xs rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-gray-300">
              All conversations saved locally with cross-session persistence
            </p>
          </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-xs rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-gray-300">
              Modern UI with mobile-first responsive design using Tailwind CSS
            </p>
          </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-xs rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-gray-300">
              Built with Next.js 15, App Router, and Turbopack for optimal
              performance
            </p>
          </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-xs rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-gray-300">
              All data stored locally - no conversation data sent to external
              servers
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-800/30 backdrop-blur-xs rounded-lg p-8 mb-16 border border-gray-700">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link
              ...
              className="text-center p-4 bg-gray-700/50 rounded-lg hover:bg-gray-600/50 transition-all duration-300 border border-gray-600 hover:border-gray-500"
            >
              <div className="text-purple-400 font-semibold">Tailwind CSS</div>
            </Link>
            <Link
              ...
              className="text-center p-4 bg-gray-700/50 rounded-lg hover:bg-gray-600/50 transition-all duration-300 border border-gray-600 hover:border-gray-500"
            >
              <div className="text-yellow-400 font-semibold">Google Gemini</div>
            </Link>
            <Link
              ...
              className="text-center p-4 bg-gray-700/50 rounded-lg hover:bg-gray-600/50 transition-all duration-300 border border-gray-600 hover:border-gray-500"
            >
              <div className="text-red-400 font-semibold">SerpAPI</div>
            </Link>
            <Link
            ...
            <Link
              ...
              className="text-center p-4 bg-gray-700/50 rounded-lg hover:bg-gray-600/50 transition-all duration-300 border border-gray-600 hover:border-gray-500"
            >
              <div className="text-pink-400 font-semibold">LocalStorage</div>
            </Link>
            <Link
              ...
              className="text-center p-4 bg-gray-700/50 rounded-lg hover:bg-gray-600/50 transition-all duration-300 border border-gray-600 hover:border-gray-500"
            >
              <div className="text-cyan-400 font-semibold">Vercel AI SDK</div>
            </Link>
          </div>
        </div>
