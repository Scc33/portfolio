...
export const projectsData = [
  ...
  },
  {
    ...
    imageUrl: "/javascript/javascript-repl-screenshot.png",
    link: "/javascript",
    date: "Winter 2025"
  },
  {
    title: "Connect 4",
    description: "A classic Connect 4 game built with React and TypeScript.",
  ...
  {
    title: "Tic Tac Toe",
    description: "A classic Tic Tac Toe game built with React and TypeScript.",
    tags: ["React", "TypeScript", "CSS"],
