    ...
    <div className="py-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold tracking-tight mb-4">BuddyCSS</h1>
        ...
        <div className="mb-12 bg-linear-to-r from-indigo-100 to-blue-100 dark:from-indigo-900 dark:to-blue-900 p-8 rounded-xl">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-full md:w-1/2">
              <h2 className="text-2xl font-semibold mb-4">Duolingo for CSS</h2>
              <p className="mb-4">
                BuddyCSS is a mobile platform designed to make learning CSS
                accessible, engaging, and fun. With a structured path from
                basics to advanced concepts, you&apos;ll master CSS one lesson
                at a time.
              </p>
              ...
              <div className="flex items-center space-x-2">
                <Check className="h-5 w-5 text-green-500" />
                <span>Track your progress with achievements</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-xs border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-center">
                Five sequential chapters with focused lessons that build upon
                previous knowledge
              </p>
            </div>
            ...
            <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-xs border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-center">
                Write real CSS code and see your changes rendered in real-time
              </p>
            </div>
            ...
            <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-xs border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-center">
                Earn points and unlock achievements as you progress through the
                curriculum
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-xs border border-gray-200 dark:border-gray-700">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium">CSS Basics</h3>
                  <p className="text-gray-600 dark:text-gray-300">
                    Learn selectors, colors, typography, and basic styling
                    concepts.
                  </p>
                </div>
              </div>
            ...
            <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-xs border border-gray-200 dark:border-gray-700">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium">Layout Fundamentals</h3>
                  <p className="text-gray-600 dark:text-gray-300">
                    Master flexbox, grid, positioning, and flow layouts.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-xs border border-gray-200 dark:border-gray-700">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Create designs that work beautifully across all device
                    sizes.
                  </p>
                </div>
              </div>
        ...
        <div className="text-center">
          ...
          <p className="mb-6">
            BuddyCSS is currently in development and will be available for iOS
            devices soon.
          </p>
          <Link
