          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              ...
              <Image
                ...
                height={160}
              />
              <Phone className="w-64" imgSrc="/ecommerce/testimonials/1.jpg" />
            </div>
          </div>
        </MaxWidthWrapper>
      </section>
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  print is perfect. I can&apos;t wait to show it off to my
                  friends.&quot;
                </p>
              </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pl-8 xl:pl-20">
              ...
              <div className="text-lg leading-8">
                <p>&quot;The case rocks. Enough said.&quot;</p>
              </div>
              <div className="flex gap-4 mt-2">
                <Image
        ...
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              <Phone className="w-60" imgSrc="/ecommerce/horse_phone.jpg" />
            </div>
          </div>
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            ...
            <div className="flex justify-center">
              <Link
                href="/ecommerce/configure/upload"
