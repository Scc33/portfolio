    ...
    <div className="p-4 space-y-4">
      ...
      <div className="space-y-2">
        <div className="flex items-center flex-wrap gap-3">
          ...
          <Button variant="secondary" size="xl" rightIcon={<StarIcon />}>
            Right Icons
          </Button>
          <Button variant="secondary" size="2xl" aria-label="Favorite">
            Button CTA
          </Button>
        </div>
      </div>
      ...
      <div className="space-y-2">
        <div className="flex items-center flex-wrap gap-3">
          ...
          <Button variant="tertiary" size="xl" rightIcon={<StarIcon />}>
            Right Icons
          </Button>
      ...
      <div className="space-y-2">
        <div className="flex items-center flex-wrap gap-3">
          ...
          <Button variant="destructive" size="xl" rightIcon={<StarIcon />}>
            Right Icons
          </Button>
          <Button variant="destructive" size="2xl" aria-label="Favorite">
            Button CTA
          </Button>
        </div>
      </div>
